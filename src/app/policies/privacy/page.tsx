...
## 🏢 1. Who We Are
**Swift Shop** is an online e-commerce platform that sells premium products across multiple categories including:
- 💻 Electronics
- 👗 Fashion
- 🏠 Home Essentials
- 👜 Accessories
...
- 🛍️ Order and transaction details
...
- 🌐 IP address
- 🖥️ Browser type & device information
- ⚙️ Operating system
- 🌍 Location data
- 📱 App usage data
- 🍪 Cookies and tracking information
- 👁️ Pages viewed and browsing activity
...
- ⚖️ Comply with legal obligations
...
> 🛡️ **Note:** We do not store full card details on our servers unless required by law or authorized payment compliance standards.
...
- 🏛️ Government authorities when legally required
...
- 🛡️ Firewall and malware protection
...
- 🏛️ File complaints with authorities
...
- 🏛️ To fulfill legal and tax obligations
- 🛡️ For fraud prevention and dispute resolution
